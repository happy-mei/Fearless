...
public class TestJavaCodegen {
  ...
  @Test void capturing() { ok("""
    ...
    record test$Usage_0Impl() implements test.Usage_0 {
      public test.Num_0 $35$imm$() {
      return  test.Usage_0.test$Usage_0$$35$imm$$noSelfCap();
    }
    ...
    record test$FPerson_0Impl() implements test.FPerson_0 {
      public test.Person_0 $35$imm$(test.Num_0 age$) {
      return  test.FPerson_0.test$FPerson_0$$35$imm$$noSelfCap(age$);
    }
  ...
  @Test void simpleProgram() { ok("""
    ...
    public test.Foo_0 $35$imm$() {
      return  test.Bar_0.test$Bar_0$$35$imm$$noSelfCap();
    }
    ...
    record test$Fear1$36_0Impl() implements test.Fear1$36_0 {
      ...
      return  test.Fear1$36_0.test$Fear1$36_0$$35$imm$$selfCap(this);
    }
  ...
  @Test void multiPackage() { ok("""
    ...
    record test$HelloWorld_0Impl() implements test.HelloWorld_0 {
      public base.Void_0 $35$imm$(base.System_0 s$) {
      return  test.HelloWorld_0.test$HelloWorld_0$$35$imm$$noSelfCap(s$);
    }
  ...
  @Test void nestedPkgs() { ok("""
    ...
    record test$A_0Impl() implements test.A_0 {
      public test$46foo.Bar_0 $35$imm$() {
      return  test.A_0.test$A_0$$35$imm$$noSelfCap();
    }
    ...
    record test$Test_0Impl() implements test.Test_0 {
      public base.Void_0 $35$imm$(base.System_0 fear0$$) {
      return  test.Test_0.test$Test_0$$35$imm$$noSelfCap(fear0$$);
    }
