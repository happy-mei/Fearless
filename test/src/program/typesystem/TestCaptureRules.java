...
//    System.out.println(code);
  ...
  @Test void t122(){ c1(read,  mut,   read,   of(read,recMdf)); }
  @Test void t123(){ c1(lent,  mut,   read,   of(read,recMdf)); }
  @Test void t124(){ c1(mut,   mut,   read,   of(read,recMdf)); }
  @Test void t125(){ c1(iso,   mut,   read,   of(read,recMdf)); }
  ...
  @Test void t157(){ c1(recMdf,recMdf,   read,   of(read,recMdf)); }
  //                     lambda, captured, method, ...capturedAs
  ...
  @Test void t267(){ c1(recMdf,recMdf,   lent,   of(read,recMdf)); }
  //                     lambda, captured, method, ...capturedAs
  ...
  @Test void t633(){ c1(lent,  mut,   recMdf, of(/*not well formed method*/)); }
  @Test void t634(){ c1(mut,   mut,   recMdf, of(/*not well formed method*/)); }
  @Test void t635(){ c1(iso,   mut,   recMdf, of(/*not well formed method*/)); }
  @Test void t636(){ c1(mdf,   mut,   recMdf, of(/*not well formed method*/)); }
  @Test void t637(){ c1(recMdf,mut,   recMdf, of(/*not well formed method*/)); }
  //                     lambda, captured, method, ...capturedAs
  @Test void t641(){ c1(imm,   iso,   recMdf, of(/*not well formed method*/)); }
  @Test void t642(){ c1(read,  iso,   recMdf, of(/*not well formed method*/)); }
  @Test void t643(){ c1(lent,  iso,   recMdf, of(/*not well formed method*/)); }
  @Test void t644(){ c1(mut,   iso,   recMdf, of(/*not well formed method*/)); }
  @Test void t645(){ c1(iso,   iso,   recMdf, of(/*not well formed method*/)); }
  @Test void t646(){ c1(mdf,   iso,   recMdf, of(/*not well formed method*/)); }
  @Test void t647(){ c1(recMdf,iso,   recMdf, of(/*not well formed method*/)); }
  //                     lambda, captured, method, ...capturedAs
  @Test void t651(){ c1(imm,   mdf,   recMdf, of(/*not well formed method*/)); }
  @Test void t652(){ c1(read,  mdf,   recMdf, of(/*not well formed method*/)); }
  @Test void t653(){ c1(lent,  mdf,   recMdf, of(/*not well formed method*/)); }
  @Test void t654(){ c1(mut,   mdf,   recMdf, of(/*not well formed method*/)); }
  @Test void t655(){ c1(iso,   mdf,   recMdf, of(/*not well formed method*/)); }
  @Test void t656(){ c1(mdf,   mdf,   recMdf, of(/*not well formed method*/)); }
  @Test void t657(){ c1(recMdf,mdf,   recMdf, of(/*not well formed method*/)); }
  //                     lambda, captured, method, ...capturedAs
  @Test void t661(){ c1(imm,   recMdf,   recMdf, of(/*not well formed method*/)); }
  @Test void t662(){ c1(read,  recMdf,   recMdf, of(/*not well formed method*/)); }
  @Test void t663(){ c1(lent,  recMdf,   recMdf, of(/*not well formed method*/)); }
  ...
  @Test void t667(){ c1(recMdf,recMdf,   recMdf, of(/*not well formed method*/)); }
  //                     lambda, captured, method, ...capturedAs
  @Test void t671(){ c1(imm,   imm,   recMdf, of(/*not well formed method*/)); }
  @Test void t672(){ c1(read,  imm,   recMdf, of(/*not well formed method*/)); }
  @Test void t673(){ c1(lent,  imm,   recMdf, of(/*not well formed method*/)); }
  @Test void t674(){ c1(mut,   imm,   recMdf, of(/*not well formed method*/)); }
  @Test void t675(){ c1(iso,   imm,   recMdf, of(/*not well formed method*/)); }
  @Test void t676(){ c1(mdf,   imm,   recMdf, of(/*not well formed method*/)); }
  @Test void t677(){ c1(recMdf,imm,   recMdf, of(/*not well formed method*/)); }
  ...
  @Test void t2112(){ c2(read,  lent,  read,   of(read,recMdf)); }// captures lent as recMdf (adapt)
  @Test void t2113(){ c2(lent,  lent,  read,   of(read,recMdf)); }//the lambda is created read, and can not become anything else but imm.
  ...
  @Test void t2122(){ c2(read,  mut,   read,   of(read,recMdf)); }
  @Test void t2123(){ c2(lent,  mut,   read,   of(read,recMdf)); }
  @Test void t2124(){ c2(mut,   mut,   read,   of(read,recMdf)); }
  @Test void t2125(){ c2(iso,   mut,   read,   of(read,recMdf)); }
  ...
  @Test void t2157(){ c2(recMdf,recMdf,   read,   of(read,recMdf)); }
  //                     lambda, captured, method, ...capturedAs
  ...
  @Test void t2267(){ c2(recMdf,recMdf,   lent,   of(read)); }
  //                     lambda, captured, method, ...capturedAs
  ...
  @Test void t3112(){ c3(read,  lent,  read,   readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read, mdf,mdf)); }// captures lent as recMdf (adapt)
  @Test void t3113(){ c3(lent,  lent,  read,   readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read, mdf,mdf)); }
  ...
  @Test void t3122(){ c3(read,  mut,   read,   readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read,  mdf,mdf)); }
  @Test void t3123(){ c3(lent,  mut,   read,   readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read,  mdf,mdf)); }
  @Test void t3124(){ c3(mut,   mut,   read,   readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read,  mdf,mdf)); }
  @Test void t3125(){ c3(iso,   mut,   read,   readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read,  mdf,mdf)); }
  ...
  @Test void t3142(){ c3(read,  mdf,   read, readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read,  mdf,mdf)); }
  @Test void t3143(){ c3(lent,  mdf,   read, readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read,  mdf,mdf)); }
  @Test void t3144(){ c3(mut,   mdf,   read, of()); }
  @Test void t3145(){ c3(iso,   mdf,   read, of()); }
  @Test void t3146(){ c3(mdf,   mdf,   read, of()); }
  @Test void t3147(){ c3(recMdf,mdf,   read, readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read,  mdf,mdf)); }
  //                     lambda, captured, method, ...capturedAs
  ...
  @Test void t3157(){ c3(recMdf,recMdf,   read,   readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read , mdf,mdf)); }
  //                     lambda, captured, method, ...capturedAs
  ...
  @Test void t3222(){ c3(read,  lent,  lent,   of()); } // this capture is fine because the method cannot ever be called
  @Test void t3223(){ c3(lent,  lent,  lent,   readAll,lentAll,of(recMdf,read, mdf,read, mdf,lent)); }
  ...
  @Test void t3233(){ c3(lent,  mut,   lent,   readAll,lentAll,of(recMdf,read, mdf,read, mdf,lent)); }
  @Test void t3234(){ c3(mut,   mut,   lent,   readAll,lentAll,of(recMdf,read, mdf,read, mdf,lent)); }
  @Test void t3235(){ c3(iso,   mut,   lent,   readAll,lentAll,of(recMdf,read, mdf,read, mdf,lent)); }
  ...
  @Test void t3267(){ c3(recMdf,recMdf,   lent,   readAll,of(recMdf,read, recMdf,mdf, recMdf,lent, recMdf,mut, mdf,read, mdf,mdf)); }
  //                     lambda, captured, method, ...capturedAs
  ...
  @Test void t3313(){ c3(lent,  read,  mut,   readAll,of(mdf,read, recMdf,read)); }
  ...
  @Test void t3323(){ c3(lent,  lent,  mut,   readAll,lentAll,of(mdf,read, mdf,lent, recMdf,read)); }
  ...
  @Test void t3334(){ c3(mut,   mut,   mut,   readAll,lentAll,of(mdf,read, mdf,lent, mdf,mut, mut,mut  , mut,lent  , mut,read  , mut,mdf  , mut,imm)); }
  @Test void t3335(){ c3(iso,   mut,   mut,   readAll,lentAll,of(mdf,read, mdf,lent, mdf,mut, mut,mut  , mut,lent  , mut,read  , mut,mdf  , mut,imm)); }
  ...
  @Test void t3367(){ c3(recMdf,recMdf,   mut,   readAll,of(mdf,read, mdf,mdf)); }
  //                     lambda, captured, method, ...capturedAs
  ...
  @Test void t3467(){ c3(recMdf,recMdf,   iso,   readAll,of(mdf,read, mdf,mdf)); }
  //                     lambda, captured, method, ...capturedAs
  ...
  //-------------------c4------------------
  @Test @Disabled void t4001(){ c4(imm,   imm,   imm,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4002(){ c4(read,  imm,   imm,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4003(){ c4(lent,  imm,   imm,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4004(){ c4(mut,   imm,   imm,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4005(){ c4(iso,   imm,   imm,   mdfImm,immAll,readAll); }
  @Test @Disabled void t4006(){ c4(mdf,   imm,   imm,   of()); }
  @Test @Disabled void t4007(){ c4(recMdf,imm,   imm,   readAll,immAll,mdfImm); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4011(){ c4(imm,   read,  imm,   of()); }
  @Test @Disabled void t4012(){ c4(read,  read,  imm,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4013(){ c4(lent,  read,  imm,   readAll,immAll,mdfImm); }
...
A:{ read .m(par: read B) : mut L[lent B] -> mut L{.absMeth->par} }
   */
  @Test @Disabled void t4014(){ c4(mut,   read,  imm,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4015(){ c4(iso,   read,  imm,   of()); }
  @Test @Disabled void t4016(){ c4(mdf,   read,  imm,   of()); }
  @Test @Disabled void t4017(){ c4(recMdf,read,  imm,   of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4021(){ c4(imm,   lent,  imm,   of()); }
  @Test @Disabled void t4022(){ c4(read,  lent,  imm,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4023(){ c4(lent,  lent,  imm,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4024(){ c4(mut,   lent,  imm,   of()); }//NOT NoMutHyg
  @Test @Disabled void t4025(){ c4(iso,   lent,  imm,   of()); }
  @Test @Disabled void t4026(){ c4(mdf,   lent,  imm,   of()); }
  @Test @Disabled void t4027(){ c4(recMdf,lent,  imm,   of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4031(){ c4(imm,   mut,   imm,  of()); }
  @Test @Disabled void t4032(){ c4(read,  mut,   imm,  readAll,immAll,mdfImm); }
  @Test @Disabled void t4033(){ c4(lent,  mut,   imm,  readAll,immAll,mdfImm); }
  @Test @Disabled void t4034(){ c4(mut,   mut,   imm,  readAll,immAll,mdfImm); }
  //two rules: imm,imm implies read,imm
  //           imm,imm on imm methods should imply imm,mut using adapt
  @Test @Disabled void t4035(){ c4(iso,   mut,   imm,  readAll,immAll,mdfImm); }
  @Test @Disabled void t4036(){ c4(mdf,   mut,   imm,  of()); }
  @Test @Disabled void t4037(){ c4(recMdf,mut,   imm,  of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4041(){ c4(imm,   iso,   imm,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4042(){ c4(read,  iso,   imm,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4043(){ c4(lent,  iso,   imm,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4044(){ c4(mut,   iso,   imm,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4045(){ c4(iso,   iso,   imm,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4046(){ c4(mdf,   iso,   imm,   of()); }
  @Test @Disabled void t4047(){ c4(recMdf,iso,   imm,   readAll,immAll,mdfImm); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4051(){ c4(imm,   mdf,   imm, readAll,immAll,mdfImm); }
  @Test @Disabled void t4052(){ c4(read,  mdf,   imm, readAll,immAll,mdfImm); }
  @Test @Disabled void t4053(){ c4(lent,  mdf,   imm, readAll,immAll,mdfImm); }
  @Test @Disabled void t4054(){ c4(mut,   mdf,   imm, of()); }
  @Test @Disabled void t4055(){ c4(iso,   mdf,   imm, of()); }
  @Test @Disabled void t4056(){ c4(mdf,   mdf,   imm, of()); }
  @Test @Disabled void t4057(){ c4(recMdf,mdf,   imm, readAll,immAll,mdfImm); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4061(){ c4(imm,   recMdf,   imm,  of()); }
  @Test @Disabled void t4062(){ c4(read,  recMdf,   imm,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4063(){ c4(lent,  recMdf,   imm,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4064(){ c4(mut,   recMdf,   imm,  of()); }
  @Test @Disabled void t4065(){ c4(iso,   recMdf,   imm,  of()); }
  @Test @Disabled void t4066(){ c4(mdf,   recMdf,   imm,   of()); }
  @Test @Disabled void t4067(){ c4(recMdf,recMdf,   imm,   readAll,immAll,mdfImm); }

  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4181(){ c4(imm,   imm,   read,   readAll,immAll,mdfImm,of(recMdf,read, recMdf,imm)); }
  @Test @Disabled void t4182(){ c4(read,  imm,   read,   readAll,immAll,mdfImm,of(recMdf,read, recMdf,imm)); }
  @Test @Disabled void t4183(){ c4(lent,  imm,   read,   readAll,immAll,mdfImm,of(recMdf,read, recMdf,imm)); }
  @Test @Disabled void t4184(){ c4(mut,   imm,   read,   readAll,immAll,mdfImm,of(recMdf,read, recMdf,imm)); }
  @Test @Disabled void t4185(){ c4(iso,   imm,   read,   readAll,immAll,mdfImm,of(recMdf,read, recMdf,imm)); }
  @Test @Disabled void t4186(){ c4(mdf,   imm,   read,   of()); }
  @Test @Disabled void t4187(){ c4(recMdf,imm,   read,   readAll,immAll,mdfImm,of(recMdf,read, recMdf,imm)); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4101(){ c4(imm,   read,  read,   of()); }
  @Test @Disabled void t4102(){ c4(read,  read,  read,   readAll,of(mdf,read, recMdf,read)); }
  @Test @Disabled void t4103(){ c4(lent,  read,  read,   readAll,of(mdf,read, recMdf,read)); }
  @Test @Disabled void t4104(){ c4(mut,   read,  read,   of()); }//NOT NoMutHyg
  @Test @Disabled void t4105(){ c4(iso,   read,  read,   of()); }
  @Test @Disabled void t4106(){ c4(mdf,   read,  read,   of()); }
  @Test @Disabled void t4107(){ c4(recMdf,read,  read,   of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4111(){ c4(imm,   lent,  read,   of()); }
  @Test @Disabled void t4112(){ c4(read,  lent,  read,   readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read)); }// captures lent as recMdf (adapt)
  @Test @Disabled void t4113(){ c4(lent,  lent,  read,   readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read)); }
  @Test @Disabled void t4114(){ c4(mut,   lent,  read,   of()); }//NOT NoMutHyg
  @Test @Disabled void t4115(){ c4(iso,   lent,  read,   of()); }
  @Test @Disabled void t4116(){ c4(mdf,   lent,  read,   of()); }
  @Test @Disabled void t4117(){ c4(recMdf,lent,  read,   of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4121(){ c4(imm,   mut,   read,  of()); }
  @Test @Disabled void t4122(){ c4(read,  mut,   read,   readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read)); }
  @Test @Disabled void t4123(){ c4(lent,  mut,   read,   readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read)); }
  @Test @Disabled void t4124(){ c4(mut,   mut,   read,   readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read)); }
  @Test @Disabled void t4125(){ c4(iso,   mut,   read,   readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read)); }
  @Test @Disabled void t4126(){ c4(mdf,   mut,   read,   of()); }
  @Test @Disabled void t4127(){ c4(recMdf,mut,   read,  of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4131(){ c4(imm,   iso,   read,   readAll,immAll,mdfImm,of(recMdf,read, recMdf,imm)); }
  @Test @Disabled void t4132(){ c4(read,  iso,   read,   readAll,immAll,mdfImm,of(recMdf,read, recMdf,imm)); }
  @Test @Disabled void t4133(){ c4(lent,  iso,   read,   readAll,immAll,mdfImm,of(recMdf,read, recMdf,imm)); }
  @Test @Disabled void t4134(){ c4(mut,   iso,   read,   readAll,immAll,mdfImm,of(recMdf,read, recMdf,imm)); }
  @Test @Disabled void t4135(){ c4(iso,   iso,   read,   readAll,immAll,mdfImm,of(recMdf,read, recMdf,imm)); }
  @Test @Disabled void t4136(){ c4(mdf,   iso,   read,   of()); }
  @Test @Disabled void t4137(){ c4(recMdf,iso,   read,   readAll,immAll,mdfImm,of(recMdf,read, recMdf,imm)); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4141(){ c4(imm,   mdf,   read, readAll,immAll,mdfImm,of(recMdf,read, recMdf,imm)); }
  @Test @Disabled void t4142(){ c4(read,  mdf,   read, readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read)); }
  @Test @Disabled void t4143(){ c4(lent,  mdf,   read, readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read)); }
  @Test @Disabled void t4144(){ c4(mut,   mdf,   read, readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read)); }
  @Test @Disabled void t4145(){ c4(iso,   mdf,   read, of()); }
  @Test @Disabled void t4146(){ c4(mdf,   mdf,   read, of()); }
  @Test @Disabled void t4147(){ c4(recMdf,mdf,   read, readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read)); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4151(){ c4(imm,   recMdf,   read,  of()); }
  @Test @Disabled void t4152(){ c4(read,  recMdf,   read,   readAll,of(mdf,read, recMdf,read)); }
  @Test @Disabled void t4153(){ c4(lent,  recMdf,   read,   readAll,of(mdf,read, recMdf,read)); }
  @Test @Disabled void t4154(){ c4(mut,   recMdf,   read,  of()); }
  @Test @Disabled void t4155(){ c4(iso,   recMdf,   read,  of()); }
  @Test @Disabled void t4156(){ c4(mdf,   recMdf,   read,   of()); }
  @Test @Disabled void t4157(){ c4(recMdf,recMdf,   read,   readAll,of(recMdf,mut  , recMdf,lent  , recMdf,read  , recMdf,mdf  , mdf,read)); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4161(){ c4(imm,   imm,   read,   readAll,immAll,mdfImm,of(recMdf,read  , recMdf,imm)); }
  @Test @Disabled void t4162(){ c4(read,  imm,   read,   readAll,immAll,mdfImm,of(recMdf,read  , recMdf,imm)); }
  @Test @Disabled void t4163(){ c4(lent,  imm,   read,   readAll,immAll,mdfImm,of(recMdf,read  , recMdf,imm)); } // this is fine because the recMdf is treated as imm
  @Test @Disabled void t4164(){ c4(mut,   imm,   read,   readAll,immAll,mdfImm,of(recMdf,read  , recMdf,imm)); }
  @Test @Disabled void t4165(){ c4(iso,   imm,   read,   readAll,immAll,mdfImm,of(recMdf,read  , recMdf,imm)); }
  @Test @Disabled void t4166(){ c4(mdf,   imm,   read,   of()); }
  @Test @Disabled void t4167(){ c4(recMdf,imm,   read,   readAll,immAll,mdfImm,of(recMdf,read  , recMdf,imm)); }

  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4201(){ c4(imm,   imm,   lent,    of()); }
  @Test @Disabled void t4202(){ c4(read,  imm,   lent,    of()); }
  @Test @Disabled void t4203(){ c4(lent,  imm,   lent,   readAll,mdfImm,immAll,of(recMdf,read  , recMdf,imm)); }
  @Test @Disabled void t4204(){ c4(mut,   imm,   lent,   readAll,mdfImm,immAll,of(recMdf,read  , recMdf,imm)); }
  @Test @Disabled void t4205(){ c4(iso,   imm,   lent,   readAll,mdfImm,immAll,of(recMdf,read  , recMdf,imm)); }
  @Test @Disabled void t4206(){ c4(mdf,   imm,   lent,   of()); }
  @Test @Disabled void t4207(){ c4(recMdf,imm,   lent,   readAll,mdfImm,immAll,of(recMdf,read  , recMdf,imm)); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4211(){ c4(imm,   read,  lent,   of()); }
  @Test @Disabled void t4212(){ c4(read,  read,  lent,   of()); }
  @Test @Disabled void t4213(){ c4(lent,  read,  lent,   readAll,of(recMdf,read, mdf,read)); }
  @Test @Disabled void t4214(){ c4(mut,   read,  lent,   of()); }//NOT NoMutHyg
  @Test @Disabled void t4215(){ c4(iso,   read,  lent,   of()); }
  @Test @Disabled void t4216(){ c4(mdf,   read,  lent,   of()); }
  @Test @Disabled void t4217(){ c4(recMdf,read,  lent,   of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4221(){ c4(imm,   lent,  lent,   of()); }
  @Test @Disabled void t4222(){ c4(read,  lent,  lent,   of()); } // this capture is fine because the method cannot ever be called
  @Test @Disabled void t4223(){ c4(lent,  lent,  lent,   readAll,lentAll,of(recMdf,read, mdf,read, mdf,lent)); }
  @Test @Disabled void t4224(){ c4(mut,   lent,  lent,   of()); }//NOT NoMutHyg
  @Test @Disabled void t4225(){ c4(iso,   lent,  lent,   of()); }
  @Test @Disabled void t4226(){ c4(mdf,   lent,  lent,   of()); }
  @Test @Disabled void t4227(){ c4(recMdf,lent,  lent,   of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4231(){ c4(imm,   mut,   lent,  of()); }
  @Test @Disabled void t4232(){ c4(read,  mut,   lent,  of()); }
  @Test @Disabled void t4233(){ c4(lent,  mut,   lent,   readAll,lentAll,of(recMdf,read, mdf,read, mdf,lent)); }
  @Test @Disabled void t4234(){ c4(mut,   mut,   lent,   readAll,lentAll,of(recMdf,read, mdf,read, mdf,lent)); }
  @Test @Disabled void t4235(){ c4(iso,   mut,   lent,   readAll,lentAll,of(recMdf,read, mdf,read, mdf,lent)); }
  @Test @Disabled void t4236(){ c4(mdf,   mut,   lent,   of()); }
  @Test @Disabled void t4237(){ c4(recMdf,mut,   lent,  of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4241(){ c4(imm,   iso,   lent,    of()); }
  @Test @Disabled void t4242(){ c4(read,  iso,   lent,    of()); }
  @Test @Disabled void t4243(){ c4(lent,  iso,   lent,   readAll,mdfImm,immAll,of(recMdf,read, recMdf,imm)); }
  @Test @Disabled void t4244(){ c4(mut,   iso,   lent,   readAll,mdfImm,immAll,of(recMdf,read, recMdf,imm)); }
  @Test @Disabled void t4245(){ c4(iso,   iso,   lent,   readAll,mdfImm,immAll,of(recMdf,read, recMdf,imm)); }
  @Test @Disabled void t4246(){ c4(mdf,   iso,   lent,   of()); }
  @Test @Disabled void t4247(){ c4(recMdf,iso,   lent,   readAll,mdfImm,immAll,of(recMdf,read, recMdf,imm)); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4251(){ c4(imm,   mdf,   lent, of()); }
  @Test @Disabled void t4252(){ c4(read,  mdf,   lent, of()); }
  @Test @Disabled void t4253(){ c4(lent,  mdf,   lent, readAll,of(recMdf,read, mdf,read)); }
  @Test @Disabled void t4254(){ c4(mut,   mdf,   lent, of()); }
  @Test @Disabled void t4255(){ c4(iso,   mdf,   lent, of()); }
  @Test @Disabled void t4256(){ c4(mdf,   mdf,   lent, of()); }
  @Test @Disabled void t4257(){ c4(recMdf,mdf,   lent, readAll,of(recMdf,read, mdf,read)); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4261(){ c4(imm,   recMdf,   lent,  of()); }
  @Test @Disabled void t4262(){ c4(read,  recMdf,   lent,  of()); }
  @Test @Disabled void t4263(){ c4(lent,  recMdf,   lent,   readAll,of(recMdf,read, mdf,read)); }
  @Test @Disabled void t4264(){ c4(mut,   recMdf,   lent,  of()); }
  @Test @Disabled void t4265(){ c4(iso,   recMdf,   lent,  of()); }
  @Test @Disabled void t4266(){ c4(mdf,   recMdf,   lent,   of()); }
  @Test @Disabled void t4267(){ c4(recMdf,recMdf,   lent,   readAll,of(recMdf,read, mdf,read)); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4271(){ c4(imm,   imm,   lent,    of()); }
  @Test @Disabled void t4272(){ c4(read,  imm,   lent,    of()); }
  @Test @Disabled void t4273(){ c4(lent,  imm,   lent,   readAll,immAll,mdfImm,of(recMdf,read, recMdf,imm)); }
  @Test @Disabled void t4274(){ c4(mut,   imm,   lent,   readAll,immAll,mdfImm,of(recMdf,read, recMdf,imm)); }
  @Test @Disabled void t4275(){ c4(iso,   imm,   lent,   readAll,immAll,mdfImm,of(recMdf,read, recMdf,imm)); }
  @Test @Disabled void t4276(){ c4(mdf,   imm,   lent,   of()); }
  @Test @Disabled void t4277(){ c4(recMdf,imm,   lent,   readAll,immAll,mdfImm,of(recMdf,read, recMdf,imm)); }

  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4301(){ c4(imm,   imm,   mut,    of()); }
  @Test @Disabled void t4302(){ c4(read,  imm,   mut,    of()); }
  @Test @Disabled void t4303(){ c4(lent,  imm,   mut,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4304(){ c4(mut,   imm,   mut,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4305(){ c4(iso,   imm,   mut,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4306(){ c4(mdf,   imm,   mut,   of()); }
  @Test @Disabled void t4307(){ c4(recMdf,imm,   mut,   readAll,immAll,mdfImm); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4311(){ c4(imm,   read,  mut,   of()); }
  @Test @Disabled void t4312(){ c4(read,  read,  mut,   of()); }
  @Test @Disabled void t4313(){ c4(lent,  read,  mut,   readAll,of(mdf,read, recMdf,read)); }
  @Test @Disabled void t4314(){ c4(mut,   read,  mut,   of()); }//NOT NoMutHyg
  @Test @Disabled void t4315(){ c4(iso,   read,  mut,   of()); }
  @Test @Disabled void t4316(){ c4(mdf,   read,  mut,   of()); }
  @Test @Disabled void t4317(){ c4(recMdf,read,  mut,   of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4321(){ c4(imm,   lent,  mut,   of()); }
  @Test @Disabled void t4322(){ c4(read,  lent,  mut,   of()); } // this capture is fine because the method cannot ever be called
  @Test @Disabled void t4323(){ c4(lent,  lent,  mut,   readAll,lentAll,of(mdf,read, mdf,lent, recMdf,read)); }
  @Test @Disabled void t4324(){ c4(mut,   lent,  mut,   of()); }//NOT NoMutHyg
  @Test @Disabled void t4325(){ c4(iso,   lent,  mut,   of()); }
  @Test @Disabled void t4326(){ c4(mdf,   lent,  mut,   of()); }
  @Test @Disabled void t4327(){ c4(recMdf,lent,  mut,   of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4331(){ c4(imm,   mut,   mut,  of()); }
  @Test @Disabled void t4332(){ c4(read,  mut,   mut,  of()); }
  @Test @Disabled void t4333(){ c4(lent,  mut,   mut,   readAll,lentAll,of(mdf,read, mdf,lent)); }
  @Test @Disabled void t4334(){ c4(mut,   mut,   mut,   readAll,lentAll,of(mdf,read, mdf,lent, mdf,mut, mut,mut  , mut,lent  , mut,read  , mut,mdf  , mut,imm)); }
  @Test @Disabled void t4335(){ c4(iso,   mut,   mut,   readAll,lentAll,of(mdf,read, mdf,lent, mdf,mut, mut,mut  , mut,lent  , mut,read  , mut,mdf  , mut,imm)); }
  @Test @Disabled void t4336(){ c4(mdf,   mut,   mut,   of()); }
  @Test @Disabled void t4337(){ c4(recMdf,mut,   mut,  of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4341(){ c4(imm,   iso,   mut,    of()); }
  @Test @Disabled void t4342(){ c4(read,  iso,   mut,    of()); }
  @Test @Disabled void t4343(){ c4(lent,  iso,   mut,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4344(){ c4(mut,   iso,   mut,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4345(){ c4(iso,   iso,   mut,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4346(){ c4(mdf,   iso,   mut,   of()); }
  @Test @Disabled void t4347(){ c4(recMdf,iso,   mut,   readAll,immAll,mdfImm); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4351(){ c4(imm,   mdf,   mut, of()); }
  @Test @Disabled void t4352(){ c4(read,  mdf,   mut, of()); }
  @Test @Disabled void t4353(){ c4(lent,  mdf,   mut, readAll,of(mdf,read)); }
  @Test @Disabled void t4354(){ c4(mut,   mdf,   mut, of()); }
  @Test @Disabled void t4355(){ c4(iso,   mdf,   mut, of()); }
  @Test @Disabled void t4356(){ c4(mdf,   mdf,   mut, of()); }
  @Test @Disabled void t4357(){ c4(recMdf,mdf,   mut, readAll,of(mdf,read)); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4361(){ c4(imm,   recMdf,   mut,  of()); }
  @Test @Disabled void t4362(){ c4(read,  recMdf,   mut,  of()); }
  @Test @Disabled void t4363(){ c4(lent,  recMdf,   mut,   readAll,of(mdf,read)); }
  @Test @Disabled void t4364(){ c4(mut,   recMdf,   mut,  of()); }
  @Test @Disabled void t4365(){ c4(iso,   recMdf,   mut,  of()); }
  @Test @Disabled void t4366(){ c4(mdf,   recMdf,   mut,   of()); }
  @Test @Disabled void t4367(){ c4(recMdf,recMdf,   mut,   readAll,of(mdf,read)); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4371(){ c4(imm,   imm,   mut,    of()); }
  @Test @Disabled void t4372(){ c4(read,  imm,   mut,    of()); }
  @Test @Disabled void t4373(){ c4(lent,  imm,   mut,   readAll,immAll,mdfImm,of()); }
  @Test @Disabled void t4374(){ c4(mut,   imm,   mut,   readAll,immAll,mdfImm,of()); }
  @Test @Disabled void t4375(){ c4(iso,   imm,   mut,   readAll,immAll,mdfImm,of()); }
  @Test @Disabled void t4376(){ c4(mdf,   imm,   mut,   of()); }
  @Test @Disabled void t4377(){ c4(recMdf,imm,   mut,   readAll,immAll,mdfImm,of()); }

  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4401(){ c4(imm,   imm,   iso,    of()); }
  @Test @Disabled void t4402(){ c4(read,  imm,   iso,    of()); }
  @Test @Disabled void t4403(){ c4(lent,  imm,   iso,   readAll,immAll,mdfImm,of()); }
  @Test @Disabled void t4404(){ c4(mut,   imm,   iso,   readAll,immAll,mdfImm,of()); }
  @Test @Disabled void t4405(){ c4(iso,   imm,   iso,   readAll,immAll,mdfImm,of()); }
  @Test @Disabled void t4406(){ c4(mdf,   imm,   iso,   of()); }
  @Test @Disabled void t4407(){ c4(recMdf,imm,   iso,   readAll,immAll,mdfImm,of()); } // yes, recMdf could be iso
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4411(){ c4(imm,   read,  iso,   of()); }
  @Test @Disabled void t4412(){ c4(read,  read,  iso,   of()); }
  @Test @Disabled void t4413(){ c4(lent,  read,  iso,   readAll,of(mdf,read)); }
  @Test @Disabled void t4414(){ c4(mut,   read,  iso,   of()); }//NOT NoMutHyg
  @Test @Disabled void t4415(){ c4(iso,   read,  iso,   of()); }
  @Test @Disabled void t4416(){ c4(mdf,   read,  iso,   of()); }
  @Test @Disabled void t4417(){ c4(recMdf,read,  iso,   of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4421(){ c4(imm,   lent,  iso,   of()); }
  @Test @Disabled void t4422(){ c4(read,  lent,  iso,   of()); }
  @Test @Disabled void t4423(){ c4(lent,  lent,  iso,   readAll,lentAll,of(mdf,read, mdf,lent)); }
  @Test @Disabled void t4424(){ c4(mut,   lent,  iso,   of()); }//NOT NoMutHyg
  @Test @Disabled void t4425(){ c4(iso,   lent,  iso,   of()); }
  @Test @Disabled void t4426(){ c4(mdf,   lent,  iso,   of()); }
  @Test @Disabled void t4427(){ c4(recMdf,lent,  iso,   of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4431(){ c4(imm,   mut,   iso,  of()); }
  @Test @Disabled void t4432(){ c4(read,  mut,   iso,  of()); }
  @Test @Disabled void t4433(){ c4(lent,  mut,   iso,   readAll,mutAll,lentAll,of(mdf,read, mdf,lent, mdf,mut)); } // These 3 look odd, but it's correct because iso lambdas are treated like mut
  @Test @Disabled void t4434(){ c4(mut,   mut,   iso,   readAll,mutAll,lentAll,of(mdf,read, mdf,lent, mdf,mut)); }
  @Test @Disabled void t4435(){ c4(iso,   mut,   iso,   readAll,mutAll,lentAll,of(mdf,read, mdf,lent, mdf,mut)); }
  @Test @Disabled void t4436(){ c4(mdf,   mut,   iso,   of()); }
  @Test @Disabled void t4437(){ c4(recMdf,mut,   iso,  of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4441(){ c4(imm,   iso,   iso,    of()); }
  @Test @Disabled void t4442(){ c4(read,  iso,   iso,    of()); }
  @Test @Disabled void t4443(){ c4(lent,  iso,   iso,   readAll,immAll,of(mdf,read, mdf,imm)); }
  @Test @Disabled void t4444(){ c4(mut,   iso,   iso,   readAll,immAll,of(mdf,read, mdf,imm)); }
  @Test @Disabled void t4445(){ c4(iso,   iso,   iso,   readAll,immAll,of(mdf,read, mdf,imm)); } // all iso is captured as imm
  @Test @Disabled void t4446(){ c4(mdf,   iso,   iso,   of()); }
  @Test @Disabled void t4447(){ c4(recMdf,iso,   iso,   readAll,immAll,of(mdf,read, mdf,imm)); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4451(){ c4(imm,   mdf,   iso, of()); }
  @Test @Disabled void t4452(){ c4(read,  mdf,   iso, of()); }
  @Test @Disabled void t4453(){ c4(lent,  mdf,   iso, readAll,of(mdf,read)); }
  @Test @Disabled void t4454(){ c4(mut,   mdf,   iso, of()); }
  @Test @Disabled void t4455(){ c4(iso,   mdf,   iso, of()); }
  @Test @Disabled void t4456(){ c4(mdf,   mdf,   iso, of()); }
  @Test @Disabled void t4457(){ c4(recMdf,mdf,   iso, readAll,of(mdf,read)); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4461(){ c4(imm,   recMdf,   iso,  of()); }
  @Test @Disabled void t4462(){ c4(read,  recMdf,   iso,  of()); }
  @Test @Disabled void t4463(){ c4(lent,  recMdf,   iso,   readAll,of(mdf,read)); }
  @Test @Disabled void t4464(){ c4(mut,   recMdf,   iso,  of()); }
  @Test @Disabled void t4465(){ c4(iso,   recMdf,   iso,  of()); }
  @Test @Disabled void t4466(){ c4(mdf,   recMdf,   iso,   of()); }
  @Test @Disabled void t4467(){ c4(recMdf,recMdf,   iso,   readAll,of(mdf,read)); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4471(){ c4(imm,   imm,   iso,    of()); }
  @Test @Disabled void t4472(){ c4(read,  imm,   iso,    of()); }
  @Test @Disabled void t4473(){ c4(lent,  imm,   iso,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4474(){ c4(mut,   imm,   iso,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4475(){ c4(iso,   imm,   iso,   readAll,immAll,mdfImm); }
  @Test @Disabled void t4476(){ c4(mdf,   imm,   iso,   of()); }
  @Test @Disabled void t4477(){ c4(recMdf,imm,   iso,   readAll,immAll,mdfImm); }

  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4501(){ c4(imm,   imm,   mdf, of()); }
  @Test @Disabled void t4502(){ c4(read,  imm,   mdf, of()); }
  @Test @Disabled void t4503(){ c4(lent,  imm,   mdf, of()); }
  @Test @Disabled void t4504(){ c4(mut,   imm,   mdf, of()); }
  @Test @Disabled void t4505(){ c4(iso,   imm,   mdf, of()); }
  @Test @Disabled void t4506(){ c4(mdf,   imm,   mdf, of()); }
  @Test @Disabled void t4507(){ c4(recMdf,imm,   mdf, of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4511(){ c4(imm,   read,  mdf, of()); }
  @Test @Disabled void t4512(){ c4(read,  read,  mdf, of()); }
  @Test @Disabled void t4513(){ c4(lent,  read,  mdf, of()); }
  @Test @Disabled void t4514(){ c4(mut,   read,  mdf, of()); }
  @Test @Disabled void t4515(){ c4(iso,   read,  mdf, of()); }
  @Test @Disabled void t4516(){ c4(mdf,   read,  mdf, of()); }
  @Test @Disabled void t4517(){ c4(recMdf,read,  mdf, of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4521(){ c4(imm,   lent,  mdf, of()); }
  @Test @Disabled void t4522(){ c4(read,  lent,  mdf, of()); }
  @Test @Disabled void t4523(){ c4(lent,  lent,  mdf, of()); }
  @Test @Disabled void t4524(){ c4(mut,   lent,  mdf, of()); }
  @Test @Disabled void t4525(){ c4(iso,   lent,  mdf, of()); }
  @Test @Disabled void t4526(){ c4(mdf,   lent,  mdf, of()); }
  @Test @Disabled void t4527(){ c4(recMdf,lent,  mdf, of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4531(){ c4(imm,   mut,   mdf, of()); }
  @Test @Disabled void t4532(){ c4(read,  mut,   mdf, of()); }
  @Test @Disabled void t4533(){ c4(lent,  mut,   mdf, of()); }
  @Test @Disabled void t4534(){ c4(mut,   mut,   mdf, of()); }
  @Test @Disabled void t4535(){ c4(iso,   mut,   mdf, of()); }
  @Test @Disabled void t4536(){ c4(mdf,   mut,   mdf, of()); }
  @Test @Disabled void t4537(){ c4(recMdf,mut,   mdf, of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4541(){ c4(imm,   iso,   mdf, of()); }
  @Test @Disabled void t4542(){ c4(read,  iso,   mdf, of()); }
  @Test @Disabled void t4543(){ c4(lent,  iso,   mdf, of()); }
  @Test @Disabled void t4544(){ c4(mut,   iso,   mdf, of()); }
  @Test @Disabled void t4545(){ c4(iso,   iso,   mdf, of()); }
  @Test @Disabled void t4546(){ c4(mdf,   iso,   mdf, of()); }
  @Test @Disabled void t4547(){ c4(recMdf,iso,   mdf, of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4551(){ c4(imm,   mdf,   mdf, of()); }
  @Test @Disabled void t4552(){ c4(read,  mdf,   mdf, of()); }
  @Test @Disabled void t4553(){ c4(lent,  mdf,   mdf, of()); }
  @Test @Disabled void t4554(){ c4(mut,   mdf,   mdf, of()); }
  @Test @Disabled void t4555(){ c4(iso,   mdf,   mdf, of()); }
  @Test @Disabled void t4556(){ c4(mdf,   mdf,   mdf, of()); }
  @Test @Disabled void t4557(){ c4(recMdf,mdf,   mdf, of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4561(){ c4(imm,   recMdf,   mdf, of()); }
  @Test @Disabled void t4562(){ c4(read,  recMdf,   mdf, of()); }
  @Test @Disabled void t4563(){ c4(lent,  recMdf,   mdf, of()); }
  @Test @Disabled void t4564(){ c4(mut,   recMdf,   mdf, of()); }
  @Test @Disabled void t4565(){ c4(iso,   recMdf,   mdf, of()); }
  @Test @Disabled void t4566(){ c4(mdf,   recMdf,   mdf, of()); }
  @Test @Disabled void t4567(){ c4(recMdf,recMdf,   mdf, of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4571(){ c4(imm,   imm,   mdf, of()); }
  @Test @Disabled void t4572(){ c4(read,  imm,   mdf, of()); }
  @Test @Disabled void t4573(){ c4(lent,  imm,   mdf, of()); }
  @Test @Disabled void t4574(){ c4(mut,   imm,   mdf, of()); }
  @Test @Disabled void t4575(){ c4(iso,   imm,   mdf, of()); }
  @Test @Disabled void t4576(){ c4(mdf,   imm,   mdf, of()); }
  @Test @Disabled void t4577(){ c4(recMdf,imm,   mdf, of()); }

  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4601(){ c4(imm,   imm,   recMdf, of()); }
  @Test @Disabled void t4602(){ c4(read,  imm,   recMdf, of()); }
  @Test @Disabled void t4603(){ c4(lent,  imm,   recMdf, of()); }
  @Test @Disabled void t4604(){ c4(mut,   imm,   recMdf, of()); }
  @Test @Disabled void t4605(){ c4(iso,   imm,   recMdf, of()); }
  @Test @Disabled void t4606(){ c4(mdf,   imm,   recMdf, of()); }
  @Test @Disabled void t4607(){ c4(recMdf,imm,   recMdf, of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4611(){ c4(imm,   read,  recMdf, of()); }
  @Test @Disabled void t4612(){ c4(read,  read,  recMdf, of()); }
  @Test @Disabled void t4613(){ c4(lent,  read,  recMdf, of()); }
  @Test @Disabled void t4614(){ c4(mut,   read,  recMdf, of()); }
  @Test @Disabled void t4615(){ c4(iso,   read,  recMdf, of()); }
  @Test @Disabled void t4616(){ c4(mdf,   read,  recMdf, of()); }
  @Test @Disabled void t4617(){ c4(recMdf,read,  recMdf, of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4621(){ c4(imm,   lent,  recMdf, of()); }
  @Test @Disabled void t4622(){ c4(read,  lent,  recMdf, of()); }
  @Test @Disabled void t4623(){ c4(lent,  lent,  recMdf, of()); }
  @Test @Disabled void t4624(){ c4(mut,   lent,  recMdf, of()); }
  @Test @Disabled void t4625(){ c4(iso,   lent,  recMdf, of()); }
  @Test @Disabled void t4626(){ c4(mdf,   lent,  recMdf, of()); }
  @Test @Disabled void t4627(){ c4(recMdf,lent,  recMdf, of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4631(){ c4(imm,   mut,   recMdf, of()); }
  @Test @Disabled void t4632(){ c4(read,  mut,   recMdf, of()); }
  @Test @Disabled void t4633(){ c4(lent,  mut,   recMdf, of()); }
  @Test @Disabled void t4634(){ c4(mut,   mut,   recMdf, of()); }
  @Test @Disabled void t4635(){ c4(iso,   mut,   recMdf, of()); }
  @Test @Disabled void t4636(){ c4(mdf,   mut,   recMdf, of()); }
  @Test @Disabled void t4637(){ c4(recMdf,mut,   recMdf, of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4641(){ c4(imm,   iso,   recMdf, of()); }
  @Test @Disabled void t4642(){ c4(read,  iso,   recMdf, of()); }
  @Test @Disabled void t4643(){ c4(lent,  iso,   recMdf, of()); }
  @Test @Disabled void t4644(){ c4(mut,   iso,   recMdf, of()); }
  @Test @Disabled void t4645(){ c4(iso,   iso,   recMdf, of()); }
  @Test @Disabled void t4646(){ c4(mdf,   iso,   recMdf, of()); }
  @Test @Disabled void t4647(){ c4(recMdf,iso,   recMdf, of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4651(){ c4(imm,   mdf,   recMdf, of()); }
  @Test @Disabled void t4652(){ c4(read,  mdf,   recMdf, of()); }
  @Test @Disabled void t4653(){ c4(lent,  mdf,   recMdf, of()); }
  @Test @Disabled void t4654(){ c4(mut,   mdf,   recMdf, of()); }
  @Test @Disabled void t4655(){ c4(iso,   mdf,   recMdf, of()); }
  @Test @Disabled void t4656(){ c4(mdf,   mdf,   recMdf, of()); }
  @Test @Disabled void t4657(){ c4(recMdf,mdf,   recMdf, of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4661(){ c4(imm,   recMdf,   recMdf, of()); }
  @Test @Disabled void t4662(){ c4(read,  recMdf,   recMdf, of()); }
  @Test @Disabled void t4663(){ c4(lent,  recMdf,   recMdf, of()); }
  @Test @Disabled void t4664(){ c4(mut,   recMdf,   recMdf, of()); }
  @Test @Disabled void t4665(){ c4(iso,   recMdf,   recMdf, of()); }
  @Test @Disabled void t4666(){ c4(mdf,   recMdf,   recMdf, of()); }
  @Test @Disabled void t4667(){ c4(recMdf,recMdf,   recMdf, of()); }
  //                     lambda, captured, method, ...capturedAs
  @Test @Disabled void t4671(){ c4(imm,   imm,   recMdf, of()); }
  @Test @Disabled void t4672(){ c4(read,  imm,   recMdf, of()); }
  @Test @Disabled void t4673(){ c4(lent,  imm,   recMdf, of()); }
  @Test @Disabled void t4674(){ c4(mut,   imm,   recMdf, of()); }
  @Test @Disabled void t4675(){ c4(iso,   imm,   recMdf, of()); }
  @Test @Disabled void t4676(){ c4(mdf,   imm,   recMdf, of()); }
  @Test @Disabled void t4677(){ c4(recMdf,imm,   recMdf, of()); }
}
