...
public class TestInferBodies {
  ...
  @Test void baseLib() { ok("""
    {test.NoMutHyg/1=Dec[name=test.NoMutHyg/1,gxs=[X],lambda=[-mdf-][test.NoMutHyg[mdfX]]{'this}],test.False/0=Dec[name=test.False/0,gxs=[],lambda=[-mdf-][test.False[],test.Bool[]]{'this.and/1([b]):Sig[mdf=imm,gens=[],ts=[immtest.Bool[]],ret=immtest.Bool[]]->this,.or/1([b]):Sig[mdf=imm,gens=[],ts=[immtest.Bool[]],ret=immtest.Bool[]]->b,.not/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.Bool[]]->[-imm-][test.Bool[],test.True[]]{'fear0$},?/1([f]):Sig[mdf=imm,gens=[X0/0$],ts=[muttest.ThenElse[immX0/0$]],ret=immX0/0$]->f.else/0[]([])}],test.Main/1=Dec[name=test.Main/1,gxs=[R],lambda=[-mdf-][test.Main[mdfR]]{'this#/1([s]):Sig[mdf=imm,gens=[],ts=[lenttest.System[]],ret=mdfR]->[-]}],test.ThenElse/1=Dec[name=test.ThenElse/1,gxs=[R],lambda=[-mdf-][test.ThenElse[mdfR]]{'this.then/0([]):Sig[mdf=mut,gens=[],ts=[],ret=immR]->[-],.else/0([]):Sig[mdf=mut,gens=[],ts=[],ret=immR]->[-]}],test.Bool/0=Dec[name=test.Bool/0,gxs=[],lambda=[-mdf-][test.Bool[],test.Sealed[]]{'this.and/1([b]):Sig[mdf=imm,gens=[],ts=[immtest.Bool[]],ret=immtest.Bool[]]->[-],.or/1([b]):Sig[mdf=imm,gens=[],ts=[immtest.Bool[]],ret=immtest.Bool[]]->[-],.not/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.Bool[]]->[-],?/1([f]):Sig[mdf=imm,gens=[R],ts=[muttest.ThenElse[immR]],ret=immR]->[-]}],test.OptMatch/2=Dec[name=test.OptMatch/2,gxs=[T,R],lambda=[-mdf-][test.OptMatch[mdfT,mdfR]]{'this.some/1([x]):Sig[mdf=imm,gens=[],ts=[immT],ret=immR]->[-],.none/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immR]->[-]}],test.Opt/0=Dec[name=test.Opt/0,gxs=[],lambda=[-mdf-][test.Opt[]]{'this#/1([x]):Sig[mdf=imm,gens=[T],ts=[immT],ret=immtest.Opt[immT]]->[-imm-][test.Opt[immT]]{'fear1$.match/1([m]):Sig[mdf=imm,gens=[X1/0$],ts=[immtest.OptMatch[immT,immX1/0$]],ret=immX1/0$]->m.some/1[]([x])}}],test.Str/0=Dec[name=test.Str/0,gxs=[],lambda=[-mdf-][test.Str[]]{'this.len/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.UInt[]]->[-]}],test.Opt/1=Dec[name=test.Opt/1,gxs=[T],lambda=[-mdf-][test.Opt[mdfT],test.NoMutHyg[immT]]{'this.match/1([m]):Sig[mdf=imm,gens=[R],ts=[immtest.OptMatch[immT,immR]],ret=immR]->m.none/0[]([]),.map/1([f]):Sig[mdf=imm,gens=[R],ts=[immtest.OptMap[immT,immR]],ret=immtest.Opt[immR]]->this.match/1[immtest.Opt[immR]]([f]),.do/1([f]):Sig[mdf=imm,gens=[],ts=[immtest.OptDo[immT]],ret=immtest.Opt[immT]]->this.match/1[immtest.Opt[immT]]([f]),.flatMap/1([f]):Sig[mdf=imm,gens=[R],ts=[immtest.OptFlatMap[immT,immR]],ret=immtest.Opt[immR]]->this.match/1[immtest.Opt[immR]]([f])}],test.Int/0=Dec[name=test.Int/0,gxs=[],lambda=[-mdf-][test.Int[],test.Sealed[],test.MathOps[immtest.Int[]],test.IntOps[immtest.Int[]],test.Stringable[]]{'this.uint/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.UInt[]]->[-],.float/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.Float[]]->[-]}],test._IntInstance/0=Dec[name=test._IntInstance/0,gxs=[],lambda=[-mdf-][test._IntInstance[],test.Int[]]{'this.uint/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.UInt[]]->this.uint/0[]([]),.float/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.Float[]]->this.float/0[]([]),.str/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.Str[]]->this.str/0[]([]),+/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Int[]],ret=immtest.Int[]]->this+/1[]([n]),-/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Int[]],ret=immtest.Int[]]->this-/1[]([n]),*/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Int[]],ret=immtest.Int[]]->this*/1[]([n]),//1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Int[]],ret=immtest.Int[]]->this//1[]([n]),%/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Int[]],ret=immtest.Int[]]->this%/1[]([n]),**/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Int[]],ret=immtest.Int[]]->this**/1[]([n]),>>/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Int[]],ret=immtest.Int[]]->this>>/1[]([n]),<</1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Int[]],ret=immtest.Int[]]->this<</1[]([n]),^/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Int[]],ret=immtest.Int[]]->this^/1[]([n]),&/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Int[]],ret=immtest.Int[]]->this&/1[]([n]),|/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Int[]],ret=immtest.Int[]]->this|/1[]([n]),>/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Int[]],ret=immtest.Bool[]]->this>/1[]([n]),</1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Int[]],ret=immtest.Bool[]]->this</1[]([n]),>=/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Int[]],ret=immtest.Bool[]]->this>=/1[]([n]),<=/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Int[]],ret=immtest.Bool[]]->this<=/1[]([n]),==/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Int[]],ret=immtest.Bool[]]->this==/1[]([n])}],test.UInt/0=Dec[name=test.UInt/0,gxs=[],lambda=[-mdf-][test.UInt[],test.Sealed[],test.MathOps[immtest.UInt[]],test.IntOps[immtest.UInt[]],test.Stringable[]]{'this.int/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.Int[]]->[-],.float/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.Float[]]->[-]}],test.OptFlatMap/2=Dec[name=test.OptFlatMap/2,gxs=[T,R],lambda=[-mdf-][test.OptFlatMap[mdfT,mdfR],test.OptMatch[immT,immtest.Opt[immR]]]{'this.none/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.Opt[immR]]->[-imm-][test.Opt[immR]]{'fear2$}}],test.OptMap/2=Dec[name=test.OptMap/2,gxs=[T,R],lambda=[-mdf-][test.OptMap[mdfT,mdfR],test.OptMatch[immT,immtest.Opt[immR]]]{'this#/1([t]):Sig[mdf=imm,gens=[],ts=[immT],ret=immR]->[-],.some/1([x]):Sig[mdf=imm,gens=[],ts=[immT],ret=immtest.Opt[immR]]->[-imm-][test.Opt[]]{'fear3$}#/1[immR]([this#/1[]([x])]),.none/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.Opt[immR]]->[-imm-][test.Opt[immR]]{'fear4$}}],test.Void/0=Dec[name=test.Void/0,gxs=[],lambda=[-mdf-][test.Void[]]{'this}],test.Sealed/0=Dec[name=test.Sealed/0,gxs=[],lambda=[-mdf-][test.Sealed[]]{'this}],test.True/0=Dec[name=test.True/0,gxs=[],lambda=[-mdf-][test.True[],test.Bool[]]{'this.and/1([b]):Sig[mdf=imm,gens=[],ts=[immtest.Bool[]],ret=immtest.Bool[]]->b,.or/1([b]):Sig[mdf=imm,gens=[],ts=[immtest.Bool[]],ret=immtest.Bool[]]->this,.not/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.Bool[]]->[-imm-][test.Bool[],test.False[]]{'fear5$},?/1([f]):Sig[mdf=imm,gens=[X0/0$],ts=[muttest.ThenElse[immX0/0$]],ret=immX0/0$]->f.then/0[]([])}],test.Let/0=Dec[name=test.Let/0,gxs=[],lambda=[-mdf-][test.Let[]]{'this#/1([l]):Sig[mdf=imm,gens=[V,R],ts=[muttest.Let[mdfV,mdfR]],ret=mdfR]->l.in/1[]([l.var/0[]([])])}],test._UIntInstance/0=Dec[name=test._UIntInstance/0,gxs=[],lambda=[-mdf-][test._UIntInstance[],test.UInt[]]{'this.int/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.Int[]]->this.int/0[]([]),.float/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.Float[]]->this.float/0[]([]),.str/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.Str[]]->this.str/0[]([]),+/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.UInt[]],ret=immtest.UInt[]]->this+/1[]([n]),-/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.UInt[]],ret=immtest.UInt[]]->this-/1[]([n]),*/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.UInt[]],ret=immtest.UInt[]]->this*/1[]([n]),//1([n]):Sig[mdf=imm,gens=[],ts=[immtest.UInt[]],ret=immtest.UInt[]]->this//1[]([n]),%/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.UInt[]],ret=immtest.UInt[]]->this%/1[]([n]),**/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.UInt[]],ret=immtest.UInt[]]->this**/1[]([n]),>>/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.UInt[]],ret=immtest.UInt[]]->this>>/1[]([n]),<</1([n]):Sig[mdf=imm,gens=[],ts=[immtest.UInt[]],ret=immtest.UInt[]]->this<</1[]([n]),^/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.UInt[]],ret=immtest.UInt[]]->this^/1[]([n]),&/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.UInt[]],ret=immtest.UInt[]]->this&/1[]([n]),|/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.UInt[]],ret=immtest.UInt[]]->this|/1[]([n]),>/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.UInt[]],ret=immtest.Bool[]]->this>/1[]([n]),</1([n]):Sig[mdf=imm,gens=[],ts=[immtest.UInt[]],ret=immtest.Bool[]]->this</1[]([n]),>=/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.UInt[]],ret=immtest.Bool[]]->this>=/1[]([n]),<=/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.UInt[]],ret=immtest.Bool[]]->this<=/1[]([n]),==/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.UInt[]],ret=immtest.Bool[]]->this==/1[]([n])}],test.Let/2=Dec[name=test.Let/2,gxs=[V,R],lambda=[-mdf-][test.Let[mdfV,mdfR]]{'this.var/0([]):Sig[mdf=mut,gens=[],ts=[],ret=mdfV]->[-],.in/1([v]):Sig[mdf=mut,gens=[],ts=[mdfV],ret=mdfR]->[-]}],test.Ref/1=Dec[name=test.Ref/1,gxs=[X],lambda=[-mdf-][test.Ref[mdfX],test.NoMutHyg[immX],test.Sealed[]]{'this*/0([]):Sig[mdf=read,gens=[],ts=[],ret=recMdfX]->[-],.swap/1([x]):Sig[mdf=mut,gens=[],ts=[mdfX],ret=mdfX]->[-],:=/1([x]):Sig[mdf=mut,gens=[],ts=[mdfX],ret=immtest.Void[]]->[-imm-][test.Let[]]{'fear6$}#/1[mdfX,immtest.Void[]]([[-mut-][test.Let[mdfX,immtest.Void[]]]{'fear7$.var/0([]):Sig[mdf=mut,gens=[],ts=[],ret=mdfX]->this.swap/1[]([x]),.in/1([_]):Sig[mdf=mut,gens=[],ts=[mdfX],ret=immtest.Void[]]->[-imm-][test.Void[]]{'fear8$}}]),<-/1([f]):Sig[mdf=mut,gens=[],ts=[muttest.UpdateRef[mdfX]],ret=mdfX]->this.swap/1[]([f#/1[]([this*/0[]([])])])}],test.System/0=Dec[name=test.System/0,gxs=[],lambda=[-mdf-][test.System[]]{'this}],test.Ref/0=Dec[name=test.Ref/0,gxs=[],lambda=[-mdf-][test.Ref[]]{'this#/1([x]):Sig[mdf=imm,gens=[X],ts=[mdfX],ret=muttest.Ref[mdfX]]->this#/1[mdfX]([x])}],test.OptDo/1=Dec[name=test.OptDo/1,gxs=[T],lambda=[-mdf-][test.OptDo[mdfT],test.OptMatch[immT,immtest.Opt[immT]]]{'this#/1([t]):Sig[mdf=imm,gens=[],ts=[immT],ret=immtest.Void[]]->[-],.some/1([x]):Sig[mdf=imm,gens=[],ts=[immT],ret=immtest.Opt[immT]]->[-imm-][test.Opt[]]{'fear9$}#/1[immT]([this._doRes/2[]([this#/1[]([x]),x])]),.none/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.Opt[immT]]->[-imm-][test.Opt[immT]]{'fear10$},._doRes/2([y,x]):Sig[mdf=imm,gens=[],ts=[immtest.Void[],immT],ret=immT]->x}],test.IntOps/1=Dec[name=test.IntOps/1,gxs=[T],lambda=[-mdf-][test.IntOps[mdfT]]{'this>>/1([n]):Sig[mdf=imm,gens=[],ts=[immT],ret=immT]->[-],<</1([n]):Sig[mdf=imm,gens=[],ts=[immT],ret=immT]->[-],^/1([n]):Sig[mdf=imm,gens=[],ts=[immT],ret=immT]->[-],&/1([n]):Sig[mdf=imm,gens=[],ts=[immT],ret=immT]->[-],|/1([n]):Sig[mdf=imm,gens=[],ts=[immT],ret=immT]->[-]}],test._FloatInstance/0=Dec[name=test._FloatInstance/0,gxs=[],lambda=[-mdf-][test._FloatInstance[],test.Float[]]{'this.int/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.Int[]]->this.int/0[]([]),.uint/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.UInt[]]->this.uint/0[]([]),.str/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.Str[]]->this.str/0[]([]),+/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Float[]],ret=immtest.Float[]]->this+/1[]([n]),-/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Float[]],ret=immtest.Float[]]->this-/1[]([n]),*/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Float[]],ret=immtest.Float[]]->this*/1[]([n]),//1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Float[]],ret=immtest.Float[]]->this//1[]([n]),%/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Float[]],ret=immtest.Float[]]->this%/1[]([n]),**/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Float[]],ret=immtest.Float[]]->this**/1[]([n]),>/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Float[]],ret=immtest.Bool[]]->this>/1[]([n]),</1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Float[]],ret=immtest.Bool[]]->this</1[]([n]),>=/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Float[]],ret=immtest.Bool[]]->this>=/1[]([n]),<=/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Float[]],ret=immtest.Bool[]]->this<=/1[]([n]),==/1([n]):Sig[mdf=imm,gens=[],ts=[immtest.Float[]],ret=immtest.Bool[]]->this==/1[]([n])}],test.Stringable/0=Dec[name=test.Stringable/0,gxs=[],lambda=[-mdf-][test.Stringable[]]{'this.str/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.Str[]]->[-]}],test.Float/0=Dec[name=test.Float/0,gxs=[],lambda=[-mdf-][test.Float[],test.Sealed[],test.MathOps[immtest.Float[]],test.Stringable[]]{'this.int/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.Int[]]->[-],.uint/0([]):Sig[mdf=imm,gens=[],ts=[],ret=immtest.UInt[]]->[-]}],test.UpdateRef/1=Dec[name=test.UpdateRef/1,gxs=[X],lambda=[-mdf-][test.UpdateRef[mdfX]]{'this#/1([x]):Sig[mdf=mut,gens=[],ts=[mdfX],ret=mdfX]->[-]}],test.MathOps/1=Dec[name=test.MathOps/1,gxs=[T],lambda=[-mdf-][test.MathOps[mdfT]]{'this+/1([n]):Sig[mdf=imm,gens=[],ts=[immT],ret=immT]->[-],-/1([n]):Sig[mdf=imm,gens=[],ts=[immT],ret=immT]->[-],*/1([n]):Sig[mdf=imm,gens=[],ts=[immT],ret=immT]->[-],//1([n]):Sig[mdf=imm,gens=[],ts=[immT],ret=immT]->[-],%/1([n]):Sig[mdf=imm,gens=[],ts=[immT],ret=immT]->[-],**/1([n]):Sig[mdf=imm,gens=[],ts=[immT],ret=immT]->[-],>/1([n]):Sig[mdf=imm,gens=[],ts=[immT],ret=immtest.Bool[]]->[-],</1([n]):Sig[mdf=imm,gens=[],ts=[immT],ret=immtest.Bool[]]->[-],>=/1([n]):Sig[mdf=imm,gens=[],ts=[immT],ret=immtest.Bool[]]->[-],<=/1([n]):Sig[mdf=imm,gens=[],ts=[immT],ret=immtest.Bool[]]->[-],==/1([n]):Sig[mdf=imm,gens=[],ts=[immT],ret=immtest.Bool[]]->[-]}]}
