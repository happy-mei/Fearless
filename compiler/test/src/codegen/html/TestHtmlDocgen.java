...
public class TestHtmlDocgen {
  ...
  @Test void emptyProgram() { ok("""
    ProgramDocs[docs=[PackageDoc[pkgName=base,traits=[TraitDoc[traitName=base.Main/0,formattedName=base.Main,content=<pre><codeclass="language-fearlesscode-block">imm#(s:mutbase.System):immbase.Void,</code></pre>],TraitDoc[traitName=base.Sealed/0,formattedName=base.Sealed,content=<pre><codeclass="language-fearlesscode-block"></code></pre>],TraitDoc[traitName=base.System/0,formattedName=base.System,content=<pre><codeclass="language-fearlesscode-block"></code></pre>],TraitDoc[traitName=base.Void/0,formattedName=base.Void,content=<pre><codeclass="language-fearlesscode-block"></code></pre>]]]]]
