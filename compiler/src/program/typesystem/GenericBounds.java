...
public interface GenericBounds {
  static Optional<? extends Supplier<CompileError>> validGenericLambda(Program p, XBs xbs, E.Lambda l) {
    return l.its().stream()
  ...
  static Optional<? extends Supplier<CompileError>> validGenericMeth(Program p, XBs xbs, Mdf recvMdf, Id.IT<T> recvIT, int depth, CM cm, List<T> typeArgs) {
  ...
  static Optional<? extends Supplier<CompileError>> validGenericIT(Program p, XBs xbs, Id.IT<T> it) {
  ...
  static Optional<? extends Supplier<CompileError>> validGenericT(Program p, XBs xbs, T t) {
    return t.match(
      gx->Optional.empty(),
