package base;
public interface ResMap_3 extends base.ResMatch_3{
...
static base.Res_2 ok$mut$fun(Object x_m$, base.ResMap_3 $this) {
...
static base.Res_2 err$mut$fun(Object x_m$, base.ResMap_3 $this) {
  return ((base.Res_2)(switch (1) { default -> {
  System.err.println("Program aborted at:\n"+java.util.Arrays.stream(Thread.currentThread().getStackTrace()).map(StackTraceElement::toString).collect(java.util.stream.Collectors.joining("\n")));
  System.exit(1);
  yield (base.Res_2) null;
