...
export class base$$caps$$UnrestrictedIO_0 extends base$$F_2 {
  static $self = new base$$caps$$UnrestrictedIO_0();

  $hash$read(sys_m$) {
  return base$$caps$$UnrestrictedIO_0.$hash$read$fun(sys_m$, this);
}
