...
export class base$$ControlFlowContinue_0 extends base$$ControlFlow_1 {
  static $self = new base$$ControlFlowContinue_0();

  match$mut(m_m$) {
  return base$$ControlFlowContinue_0.match$mut$fun(m_m$, this);
}
