...
public final class CapTry implements FProgram.base$46caps.CapTry_0 {
	...
	@Override public FProgram.base.Res_2 $35$mut$(FProgram.base$46caps.TryBody_1 try$) {
		...
		catch(java.lang.StackOverflowError _$err) { return FProgram.base.Res_0._$self.err$imm$(FProgram.base.FInfo_0._$self.str$imm$(StackOverflowedErrStr._self$)); }
		catch(Throwable _$err) { return FProgram.base.Res_0._$self.err$imm$(FProgram.base.FInfo_0._$self.str$imm$(Str.fromJavaStr(_$err.getMessage()))); }
	}
