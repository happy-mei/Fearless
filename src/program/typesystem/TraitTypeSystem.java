...
public interface TraitTypeSystem {
  Program p();
  static List<Supplier<CompileError>> dsOk(TypeSystemFeatures tsf, Collection<Dec> ds, IdentityHashMap<E.MCall, EMethTypeSystem.TsT> resolvedCalls){
  ...
  default Optional<Supplier<CompileError>> dOk(Dec d, IdentityHashMap<E.MCall, EMethTypeSystem.TsT> resolvedCalls){
    var c=d.name();
    var xs=d.gxs();
    var b=d.lambda();
